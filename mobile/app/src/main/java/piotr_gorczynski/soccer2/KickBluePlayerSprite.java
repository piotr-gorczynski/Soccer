...
final class KickBluePlayerSprite {

    private static final int ROW_HEIGHT = 128;
    // The blue sprites occupy the lower half of the shared kick sheet. The first
    ...
    private static Bitmap[] getFramesForRow(Context context, int rowIndex) {
        ...
        return KickPlayerSprite.getFrames(context, startY);
    }
}
