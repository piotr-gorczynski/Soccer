...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Log.d("Soccer", "InvitationsActivity onNewIntent: " + intent.toUri(Intent.URI_INTENT_SCHEME));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(task -> {
                    ...
                    Log.d("Soccer", "🔑 Token from MenuActivity: " + token);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == NOTIFICATION_PERMISSION_REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Log.d("Soccer", "✅ Notification permission granted");
            } else {
...
//---save whatever you need to persist—
        Log.d("Soccer", "123456: MenuActivity.onSaveInstanceState entered");
