        ...
        for (String friendUid : friendUids) {
            ...
            friendStatusRef.get()
                    .addOnSuccessListener(snapshot -> {
                        ...
                        // Try to read the heartbeat as Long first, then fall back to Double if needed.
                        // Firebase Database doesn't support deserializing to Number.class.
                        try {
                            ...
                            Log.e(TAG, "sortByLastSeen: Error reading heartbeat for friend " + capturedUid, e);
                        }
