...
/**
 * Test cases for TournamentLobbyActivity null user handling
 * Tests that the activity properly handles the case when auth.getCurrentUser() returns null
 */
public class TournamentLobbyNullUserTest {
    ...
    @Test
    public void testPreventNullPointerException() {
        // Test that the null check prevents NullPointerException
